...
function RouteMapper(options) {
  ...
  function routeMapper(overrides) {
    ...
    return RouteMapper({
      RESOURCE_KEY: overrides.RESOURCE_KEY || state.RESOURCE_KEY,
      PARAMS_PATTERN: overrides.PARAMS_PATTERN || state.PARAMS_PATTERN,
      SUPPORTED_ACTIONS: overrides.SUPPORTED_ACTIONS || state.SUPPORTED_ACTIONS
    });
  }
